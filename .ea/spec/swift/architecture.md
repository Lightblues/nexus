...
Single-process macOS app. Replaces Electron's main + 4 helper processes with one binary
that hosts: status item, popover, main window, palette panel, and all background services.
